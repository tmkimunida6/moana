...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'flex items-center justify-center rounded-md gap-6 text-muted-foreground mb-6',
      className,
    )}
    {...props}
  />
